...
function formatWtsMessage(msgData = {}) {
  ...
  if(msgData.classificacao) message += `Ocupação: ${msgData.classificacao}\n`;
  if(msgData.valor) message += `Valor: ${msgData.valor}\n`;
  if(msgData.cep) message += `CEP: ${msgData.cep}\n`;
  if(msgData.cia) message += `Companhia: ${msgData.cia}\n`;
